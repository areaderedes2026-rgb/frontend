...
export function HomeEventsAgenda({ events = [], loading = false }) {
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_55%_at_15%_0%,rgba(56,189,248,0.16),transparent_60%)]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_50%_45%_at_100%_100%,rgba(14,165,233,0.12),transparent_65%)]"
        aria-hidden
      />
