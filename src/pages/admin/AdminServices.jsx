...
function mapContentToForm(content) {
  ...
  return {
    ...
    showHeroBadge: normalizeHeroToggle(content.showHeroBadge, true),
    showHeroTitle: normalizeHeroToggle(content.showHeroTitle, true),
    showHeroSubtitle: normalizeHeroToggle(content.showHeroSubtitle, true),
    showSearch: normalizeHeroToggle(content.showSearch, true),
    showPrimaryButton: normalizeHeroToggle(content.showPrimaryButton, true),
    showSecondaryButton: normalizeHeroToggle(content.showSecondaryButton, true),
