...
export function LegisladorEste() {
  ...
  const [content, setContent] = useState(() =>
    apiEnabled ? DEFAULT_LEGISLADOR_ESTE_CONTENT : DEFAULT_LEGISLADOR_ESTE_CONTENT,
  )
  const [contentHydrated, setContentHydrated] = useState(!apiEnabled)
  ...
  useEffect(() => {
    ...
    async function loadContent() {
      ...
      try {
        ...
        if (!cancelled) {
          setContent({ ...DEFAULT_LEGISLADOR_ESTE_CONTENT })
        }
      } finally {
  ...
  const loadingContent = apiEnabled && !contentHydrated
