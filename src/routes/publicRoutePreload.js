...
export const publicRouteLoaders = {
  ...
  tourism: namedLazy(() => import('../pages/tourism/Turismo.jsx'), 'Turismo'),
  tourismPlaceDetail: namedLazy(
    () => import('../pages/tourism/TourismPlaceDetail.jsx'),
    'TourismPlaceDetail',
  ),
  ...
  areaOfficeDetail: namedLazy(
    () => import('../pages/areas/AreaOfficeDetail.jsx'),
    'AreaOfficeDetail',
  ),
  areaServiceDetail: namedLazy(
    () => import('../pages/areas/AreaServiceDetail.jsx'),
    'AreaServiceDetail',
  ),
  ...
  governmentLegisladorEste: namedLazy(
    () => import('../pages/government/LegisladorEste.jsx'),
    'LegisladorEste',
  ),
  governmentConcejoDeliberante: namedLazy(
    () => import('../pages/government/ConcejoDeliberante.jsx'),
    'ConcejoDeliberante',
  ),
